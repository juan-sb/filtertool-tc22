...
class Ui_case_dialog(object):
    ...
    def retranslateUi(self, case_dialog):
        ...
        self.case_transform_cb.setItemText(1, _translate("case_dialog", "dB: 20log(.)"))
        self.case_transform_cb.setItemText(2, _translate("case_dialog", "dBW: 10log(.)"))
        self.case_transform_cb.setItemText(3, _translate("case_dialog", "dBm: 10log(.) + 30"))
